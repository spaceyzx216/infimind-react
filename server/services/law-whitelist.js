...
export const LAW_WHITELIST_SEED = [
  ...
  {
    title: '中华人民共和国公司法',
    // 别名要覆盖模型的各种写法：无书名号引用、带"新"字的口语说法
    aliases: ['公司法', '新公司法', '公司法2023修订', '公司法2023年修订'],
    versionLabel: '2023年修订',
    docNumber: '中华人民共和国主席令第十五号',
    issuingBody: '全国人民代表大会常务委员会',
    effectiveFrom: '2024-07-01',
    status: 'effective',
    reviewStatus: 'verified',
    verifiedBy: 'user-provided-official-text',
    sourceUrl: 'https://flk.npc.gov.cn/detail?title=%E4%B8%AD%E5%8D%8E%E4%BA%BA%E6%B0%91%E5%85%B1%E5%92%8C%E5%9B%BD%E5%85%AC%E5%8F%B8%E6%B3%95&id=ff8081818c9108eb018cb6922f750c07',
    note: '2023-12-29 第十四届全国人大常委会第七次会议第二次修订通过，共15章266条，'
      + '自 2024-07-01 起施行。**不存在"2024年修订版"，也不存在"2018年修订版"**——'
      + '2018-10-26 是第四次**修正**（旧版），现行有效的是本次修订版。'
      + '用工相关条款索引：第16条（保护职工合法权益、依法签订劳动合同、参加社会保险、劳动保护、职业教育与岗位培训）；'
      + '第17条（组织工会、工会代表职工签订集体合同、以职工代表大会为基本形式的民主管理、'
      + '研究决定改制解散破产及制定重要规章制度时应听取工会与职工意见）；'
      + '第20条（经营须考虑职工等利益相关者利益、承担社会责任）；'
      + '第68条（职工人数300人以上的有限责任公司，除依法设监事会并有职工代表外，董事会成员中应当有职工代表）；'
      + '第76条、第130条（监事会应含股东代表和适当比例职工代表，职工代表比例不得低于三分之一）；'
      + '第121条（审计委员会成员中的职工代表）；第173条（国有独资公司董事会应有职工代表）；'
      + '第236条（清算财产在支付清算费用后，**优先清偿职工的工资、社会保险费用和法定补偿金**）。'
  },
  {
